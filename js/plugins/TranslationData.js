...
wordBank = {
    en: {
        ...
        optionDescriptions: {
            ...
            stretchMode: Utils.isNwjs() ? "When enabled, will stretch the game's contents to fit the whole screen when in fullscreen mode. This can make it look distorted at\nsome resolutions. When disabled, the game will always render at a pixel-perfect resolution."
                : "When enabled, will stretch the game's contents to fit the whole window. This can make it look distorted at some resolutions.\nWhen disabled, the game will always render at a pixel-perfect resolution.",
            keyConfig: "Allows you to customise the game's controls.",
            lang: "Sets the language of the game.\nCan only be changed from the title screen.",
            messageSpeedKey: "Changes the speed at which text appears in messages.",
            cBlind: "This option adjusts some puzzles that would otherwise require distinguishing between colours in order to solve them.",
        ...
        importPrompt: "This option allows you to import a previously exported game save.\nTo use it, make sure you have an exported save in your clipboard.\n",
        exportGame: "Export save",
        exportPrompt: "This options allows you to export your current savefile as text, which you'll be able to import\non another device or in a different version of the game.\n\nThis block of text will be rather large, so it will be put directly into your clipboard.\nYou'll be able to paste it somewhere else afterwards.\n\nExported saves don't include some things, e.g. the player's position or keyboard settings,\nbut they do include all progression-related data, e.g. found fragments or the history of\ninteractions with things in the Vault.\n",
        replayTutorial: "Replay tutorials",
        credits: "Credits",
        feedback: "Feedback",
        exit: "Exit",
        back: "Back",
        language: "Language",
        messageSpeedOption: "Text speed",
        speedOptions: ["Very Slow", "Slow", "Normal", "Fast", "Very Fast", "Really Fast", "Instant"],
        colorblindMode: "Colourblind mode",
        controlsOption: "Controls",
        masterVolume: "Master volume",
        colorblindPrompt: "Would you like to enable colourblind mode?\n\nThis mode adjusts some puzzles that would otherwise require\ndistinguishing between colours in order to solve them.",
        mobileWarning: "It looks like you're on a mobile device.\nSupport for mobile devices is still a work in progress, and the game might not work properly.\n\nIf you can, playing the game on a desktop is recommended.\n",
        close: "Close",
        copy: "Copy",
        clipboardMessage: "Copied to clipboard.",
        clipboardFailMessage: "Failed to access the clipboard",
        resume: "Resume",
        ...
        webStretchMode: "Stretch to fit the window",
        ...
        anotherWrong: (count) => { return { string: `Attempt number ${count}: it's still not correct.${count >= 10 ? "\nI'm starting to get the feeling that further attempts will not\n change that." : ''}`, id: 0 } },
        //Molecule helper
        unknownFormula: "Not found in the database.",
        formula: "Formula",
        anomalousProperties: "Anomalous properties",
        isAnomalous: "Detected",
        isNotAnomalous: "None found",
    },
    pl: {
        ...
        optionDescriptions: {
            ...
            markerMode: "Przytrzymaj: interaktywne obiekty będą zaznaczone, kiedy przytrzymasz F.\nPrzełącz: wciśnięcie F będzie włączać lub wyłączać zaznaczanie interaktywnych obiektów.",
            ...
            stretchMode: "Dopasowuje rozmiar gry do rozmiaru ${Utils.isNwjs() ? 'ekranu w trybie pełnoekranowym' : 'okna'}. Przy niektórych rozdzielczościach może to zniekształcić obraz.\nGdy ta opcja jest wyłączona, gra będzie wyświetlać się w natywnej rozdzielczości.",
            keyConfig: "Pozawala na zmianę ustawień sterowania.",
            lang: "Zmienia język gry.\nTę opcję można zmienić tylko w menu głównym.",
            messageSpeedKey: "Prędkość pojawiania się dialogów w grze.",
        ...
        exit: "Wyjdź",
        back: "Wróć",
        messageSpeedOption: "Prędkość tekstu",
        speedOptions: ["Bardzo wolna", "Wolna", "Normalna", "Szybka", "Szybsza", "Najszybsza", "Natychmiast"],
        // speedOptions: ["x0.33", "x0.5", "Normalna", "x2", "x3", "x5", "Natychmiast"],
        language: "Język",
        ...
        mobileWarning: "Wygląda na to, że używasz urządzenia mobilnego.\nWsparcie dla nich nie jest jeszcze w pełni gotowe - gra może nie działać prawidłowo.\n\nJeśli możesz, używanie komputera jest zalecane.",
        close: "Zamknij",
        copy: "Kopiuj",
        clipboardMessage: "Skopiowano do schowka.",
        clipboardFailMessage: "Operacja nieudana\nBrak dostępu do schowka",
        back: "Wróć",
        resume: "Wznów",
        ...
        stretchMode: "Dopasuj do ekranu",
        webStretchMode: "Dopasuj do okna",
        markerMode: "Zaznacz interaktywne",
        markerToggle: "Przełącz",
        markerHold: "Przytrzymaj",
        autosave: "Autozapis",
        ...
        addPolishCharacters: "A wydawało się to mieć sens.\nMoże trzeba po prostu użyć tu polskich znaków?",
        randomSuccessMessages: (currentKeys) => [
        ...
        anotherWrong: (count) => { return { string: `Podejście ${count}: dalej nie działa.${count >= 10 ? "\nMam wrażenie, że kolejne próby mogą skończyć się podobnie." : ''}`, id: 0 } },
        //Molecule helper
        unknownFormula: "Nie znaleziono w bazie danych.",
        formula: "Wzór",
        anomalousProperties: "Anomalie",
        isAnomalous: "Zaobserwowano",
        isNotAnomalous: "Nie zaobserwowano",
    }
}