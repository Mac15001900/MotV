...
wordBank = {
    en: {
        ...
        optionDescriptions: {
            ...
            stretchMode: `When enabled, will stretch the game's contents to fit the whole ${Utils.isNwjs() ? 'screen' : 'window'}. This may make it look distorted at some resolutions.\nWhen disabled, it will always render at a pixel-perfect resolution, which might not fit on smaller screens.`,
    ...
    pl: {
        ...
        optionDescriptions: {
            ...
            stretchMode: "Dopasowuje rozmiar gry do rozmiaru ${Utils.isNwjs() ? 'ekranu' : 'okna'}. Przy niektórych rozdzielczościach może to zniekształcić obraz.\nGdy ta opcja jest wyłączona, gra będzie wyświetlać się w natywnej rozdzielczości, co może nie zmieścić się na mniejszych ekranach.",
